...
|------|-------------|-----------|
| 10. Validate and Test Changes | Guidelines for generating modern Terraform code for Azure | instructions/generate-modern-terraform-code-for-azure.instructions.md |
| Additional Guidelines | Angular-specific coding standards and best practices | instructions/angular.instructions.md |
| API Documentation and Swagger | Blazor component and application patterns | instructions/blazor.instructions.md |
| API Documentation and Swagger | .NET MAUI component and application patterns | instructions/dotnet-maui.instructions.md |
| Build and Verification | Guidelines for building Java base applications | instructions/java.instructions.md |
| Build and Verification | Guidelines for building Spring Boot base applications | instructions/springboot.instructions.md |
| cmake-vcpkg.instructions.md | C++ project configuration and package management | instructions/cmake-vcpkg.instructions.md |
| Common Issues | Quarkus and MCP Server with HTTP SSE transport development standards and instructions | instructions/quarkus-mcp-server-sse.instructions.md |
| Common Patterns | ReactJS development standards and best practices | instructions/reactjs.instructions.md |
| Common Patterns | Guidelines for building TanStack Start applications | instructions/tanstack-start-shadcn-tailwind.instructions.md |
| Common Patterns | VueJS 3 development standards and best practices with Composition API and TypeScript | instructions/vuejs3.instructions.md |
| Common Pitfalls to Avoid | Instructions for writing Go code following idiomatic Go practices and community standards | instructions/go.instructions.md |
| Conclusion | Comprehensive best practices for creating optimized, secure, and efficient Docker images and managing containers. Covers multi-stage builds, image layer optimization, security scanning, and runtime best practices. | instructions/containerization-docker-best-practices.instructions.md |
...
| Disclaimer | Guidelines for localizing markdown documents | instructions/localization.instructions.md |
| Documentation | Infrastructure as Code with Bicep | instructions/bicep-code-best-practices.instructions.md |
| EARS Notation Reference | Specification-Driven Workflow v1 provides a structured approach to software development, ensuring that requirements are clearly defined, designs are meticulously planned, and implementations are thoroughly documented and validated. | instructions/spec-driven-workflow-v1.instructions.md |
| Example of Proper Documentation | Python coding conventions and guidelines | instructions/python.instructions.md |
| Final Notes | Gilfoyle-style code review instructions that channel the sardonic technical supremacy of Silicon Valley''s most arrogant systems architect. | instructions/gilfoyle-code-review.instructions.md |
| Full Example: End-to-End Cmdlet Pattern | PowerShell cmdlet and scripting best practices based on Microsoft guidelines | instructions/powershell.instructions.md |
| General Guidelines | Comprehensive secure coding instructions for all languages and frameworks, based on OWASP Top 10 and industry best practices. | instructions/security-and-owasp.instructions.md |
| Guidance for Code Generation | TypeScript patterns for Azure Functions | instructions/azure-functions-typescript.instructions.md |
| Guidance for Code Generation | AI-powered script generation guidelines | instructions/genaiscript.instructions.md |
...
| Name | Description | File Path |
|------|-------------|-----------|
| 10.{x}. {User story title} | Generate a comprehensive Product Requirements Document (PRD) in Markdown, detailing user stories, acceptance criteria, technical considerations, and metrics. Optionally create GitHub issues upon user confirmation. | chatmodes/prd.chatmode.md |
| 11. Related Specifications / Further Reading | Generate or update specification documents for new or existing functionality. | chatmodes/specification.chatmode.md |
| 8. Related Specifications / Further Reading | Generate an implementation plan for new features or refactoring existing code. | chatmodes/implementation-plan.chatmode.md |
| Additional Links | Work with Microsoft SQL Server databases using the MS SQL extension. | chatmodes/ms-sql-dba.chatmode.md |
| Analysis Order | Perform janitorial tasks on C#/.NET code including cleanup, modernization, and tech debt remediation. | chatmodes/csharp-dotnet-janitor.chatmode.md |
| Analysis Priority | Perform janitorial tasks on any codebase including cleanup, simplification, and tech debt remediation. | chatmodes/janitor.chatmode.md |
| Best practices | Create, update, or review Azure IaC in Bicep using Azure Verified Modules (AVM). | chatmodes/azure-verified-modules-bicep.chatmode.md |
| Best practices | Create, update, or review Azure IaC in Terraform using Azure Verified Modules (AVM). | chatmodes/azure-verified-modules-terraform.chatmode.md |
...
| Example Question Patterns | Validate user understanding of code, design patterns, and implementation details through guided questioning. | chatmodes/demonstrate-understanding.chatmode.md |
| Examples of Good Communication | Rust GPT-4.1 Coding Beast Mode for VS Code | chatmodes/rust-gpt-4.1-beast-mode.chatmode.md |
| Expert .NET software engineer mode instructions | Provide expert .NET software engineering guidance using modern software design patterns. | chatmodes/expert-dotnet-software-engineer.chatmode.md |
...
| Key SaaS Focus Areas | Provide expert Azure SaaS Architect guidance focusing on multitenant applications using Azure Well-Architected SaaS principles and Microsoft best practices. | chatmodes/azure-saas-architect.chatmode.md |
| Mentor mode instructions | Help mentor the engineer by providing guidance and support. | chatmodes/mentor.chatmode.md |
| meta-agentic-project-scaffold.chatmode.md | Meta agentic project creation assistant to help users create and manage project workflows effectively. | chatmodes/meta-agentic-project-scaffold.chatmode.md |
| Notes [optional] | A specialized chat mode for analyzing and improving prompts. Every user input is treated as a propt to be improved. It first provides a detailed analysis of the original prompt within a <reasoning> tag, evaluating it against a systematic framework based on OpenAI's prompt engineering best practices. Following the analysis, it generates a new, improved prompt. | chatmodes/prompt-engineer.chatmode.md |
| Output | Refine the requirement or issue with Acceptance Criteria, Technical Considerations, Edge Cases, and NFRs | chatmodes/refine-issue.chatmode.md |
